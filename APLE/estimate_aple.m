...
for m=1:M
    ...
    aoa=aple_2d_valse( ...
        ym,sub.Nx,sub.Ny,arrayConfig.d,lambda,sigma2, ...
        'gridSize',max(721,options.gridSize), ...
        'minKappa',options.minKappa);
...
result=struct('position',position,'positionCovariance',positionCovariance,'positionCovarianceCondition',positionCovarianceCondition, ...
    'isOriginalVALSE',false,'aoaMethod','paper_eq18_23_2d_variational_valse','posteriorMu',posteriorMu,'posteriorKappa',posteriorKappa, ...
